...
class SelectFood extends React.Component {
  render() {
    ...
    if (
      this.props.state.mainButtonState === BUTTON_STATE.DAIRY_BUTTON_SELECTED
    ) {
      return (
        <div>
          <FoodGrid
    ...
    if (
      this.props.state.mainButtonState ===
      BUTTON_STATE.NON_PERSIHABLES_PAGE_BUTTON
    ) {
      return (
        <div>
          <FoodGrid
    ...
    if (
      this.props.state.currentPageState === FLOW_STATE.MAINPAGE &&
      this.props.state.mainButtonState != null
    ) {
      return (
        <div>
...
const mapDispatchToProps = dispatch => {
  return {
    initialState: () => dispatch(mainPageState(FLOW_STATE.MAINPAGE))
  };
};

let SelectedGroceriesPage = connect(
  mapStateToProps,
  mapDispatchToProps
)(SelectFood);

export default SelectedGroceriesPage;
